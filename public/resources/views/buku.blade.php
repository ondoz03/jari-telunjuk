                    ...
                    <section class="col-span-1 border-b border-[#dedede] pb-12 xl:col-span-8">
                        <header class="mb-4 flex items-center justify-between xl:mb-8">
                            ...
                            <div class="relative hidden w-72 xl:block">
                                ...
                                <form action="{{ route('buku', $kategori->name) }}"
                                    method="get">

                                    <input name="search"
                                        class="w-full rounded-full border border-[#DEDEDE] px-6 py-2 text-sm text-[#2e2e2e] outline-none ring-2 ring-transparent placeholder:text-stone-500 focus:border-stone-300 focus:ring-[#DEDEDE]/25"
                                        type="text"
                                        placeholder="Cari buku berdasarkan kategori ...">
                                    <input type="hidden"
                                        name="type"
                                        value="ketegori">
                                    <input type="hidden"
                        ...
                        <div class="space-y-6">
                            ...
                            <nav class="flex flex-col items-start gap-3">
                                @foreach (GeneralHelper::getRandomGetCategory() as $item)
                                    <a class="text-[#128C55] hover:underline"
                                    ...
                                    <figure
                                        ...
                                        <div class="w-full px-2 pb-3.5 pt-1.5 xl:p-5 astro-J7PV25F6">
                                            ...
                                            <p class="text-sm leading-5 text-[#2e2e2e] xl:text-base astro-J7PV25F6"
                                                ...
                                                <span
                                                    class="astro-J7PV25F6">{{ date('d, M Y', strtotime($item['date'])) }}</span>
                                            </p>
                                        </div>
                                    </figure>
                                @endforeach
