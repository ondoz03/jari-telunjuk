...
@section('content')
    ...
    <div id="modal-book-recommendation-new" class="fixed inset-0 z-[999999999] hidden h-full w-full items-center justify-center astro-J7PV25F6">
        ...
        <div id="recommend-book-section" class="fixed z-20 h-screen w-full max-w-4xl overflow-hidden bg-white p-0 lg:h-full lg:max-h-[576px] lg:rounded-2xl lg:p-11 astro-J7PV25F6">
            <header class="mb-5 mt-5 flex items-center sh-screen justify-between px-4 xl:justify-center astro-J7PV25F6" style="top:0;">
...
{{--            <header--}}
{{--                    class="fixed inset-0 z-[60] h-screen w-full bg-white">--}}
{{--                <div--}}
...
<script>
    ...
    window.onscroll = function() {
        ...
        if (prevScrollPos > currentScrollPos) {
            ...
            header.style.top = "-100px"; // Adjust the value based on your navbar's height
        }
