                ...
                <div class="modal__container rounded-none xl:rounded-2xl astro-J7PV25F6"
                    ...
                    <div id="modal-1-container">
                                ...
                                <ul class="flex w-full flex-row flex-wrap gap-3 astro-J7PV25F6">
                                    @foreach (GeneralHelper::getKategory() as $kategori)
                                        <li class="astro-J7PV25F6">
                                            <input type="checkbox"
                                                id="{{ $kategori->id . '_kategori' }}"
                                                value="{{ $kategori->id }}"
                                                name="kategori"
                                                class="peer hidden astro-J7PV25F6 kategori"
                                                required="">
                                            <label for="{{ $kategori->id . '_kategori' }}"
                                                class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-J7PV25F6">
                                                <div class="w-full text-sm font-semibold xl:text-lg astro-J7PV25F6">
                                                    {{ $kategori->name }}
                                                </div>
                                                <svg class="flex-shrink-0 astro-J7PV25F6"
                                                    width="16"
                                                    height="20"
                                                    viewBox="0 0 16 20"
                                                    fill="none"
                        ...
                        <footer class="flex items-center justify-between bg-[#F9F8F6] p-4 xl:px-8 xl:py-12 astro-J7PV25F6">
                            <button class="text-2xl font-bold leading-7 astro-J7PV25F6"><span
                                    id="countSelectedCategory">0</span>/5</button>
                            <button
                                class="rounded-full bg-[#128C55] px-6 py-4 font-source-sans text-base font-semibold leading-none tracking-widest text-white astro-J7PV25F6"
                                aria-label="Close this dialog window"
                                id="submitCategory">Selesai</button>
                        </footer>
                    </div>
                    <div id="modal-2-container"
                        style="display:none">
                        <header class="mb-6 mt-11 flex items-center justify-between px-4 xl:justify-center astro-J7PV25F6">
                            <h2 class="text-center font-arvo text-xl leading-none xl:text-[34px] astro-J7PV25F6"
                                id="modal-2-title">
                        ...
                        <div class="flex w-full items-center justify-center gap-4 px-4 lg:px-0">
                            <div class="relative w-full lg:max-w-sm">
                                <svg class="absolute left-4 top-1/2 z-10 h-6 w-6 -translate-y-1/2 lg:left-6"
                                    viewBox="0 0 24 24"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <main class="modal__content px-4 !font-source-sans xl:px-8 astro-J7PV25F6"
                            id="modal-2-content">
                            <div class="grid w-full grid-cols-3 place-items-center justify-center gap-4 lg:grid-cols-7 lg:gap-6"
                        ...
                        <footer class="flex items-center justify-between bg-[#F9F8F6] p-4 xl:px-8 xl:py-12 astro-J7PV25F6">
                            ...
                            <div class="flex w-full flex-row gap-2 lg:w-auto lg:gap-4">
                                <button
                                    class="rounded-full border border-[#222222] bg-white px-6 py-4 font-source-sans text-base font-semibold leading-none tracking-widest text-[#222222] astro-J7PV25F6"
                                    aria-label="Close this dialog window"
                                    id="sebelumnya_book">Sebelumnya</button>
                                <button
                                    class="rounded-full bg-[#128C55] px-6 py-4 font-source-sans text-base font-semibold leading-none tracking-widest text-white astro-J7PV25F6"
                                    aria-label="Close this dialog window"
                                    id="submitBook">Selesai</button>
                            </div>
                        </footer>
                    </div>
                    <div id="modal-3-container"
                        style="display:none">
                        <header class="mb-6 mt-11 flex items-center justify-between px-4 xl:justify-center astro-J7PV25F6">
                            <h2 class="text-center font-arvo text-xl leading-none xl:text-[34px] astro-J7PV25F6"
                                id="modal-2-title">
