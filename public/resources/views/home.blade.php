...
@section('content')
    <main class="relative">
                ...
                <div class="container mx-auto max-w-screen-xl space-y-6 px-4 xl:space-y-20 xl:px-12 astro-J7PV25F6">
                    ...
                    <div class="relative flex w-full flex-col items-center pt-4 astro-J7PV25F6">
                        ...
                        @guest
                            ...
                            <button id="book-recommendation" type="button" class="flex w-60 items-center justify-center rounded-full bg-[#128C55] px-6 py-4 font-bold text-white transition-all duration-300 ease-out hover:bg-[#128C55]/90 astro-LUHUBFT3 xl:hidden">
                                Coba Rekomendasi Buku
                            </button>
                        @else
        ...
        <div class="modal micromodal-slide astro-LUHUBFT3" id="modal-1" aria-hidden="true">
            <div class="modal__overlay astro-LUHUBFT3" tabindex="-1" data-micromodal-close>
                <div class="modal__container flex flex-col items-start rounded-none xl:rounded-2xl astro-LUHUBFT3" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                    <header class="flex h-[72px] w-full items-center justify-between bg-white px-4 py-6 xl:justify-center astro-LUHUBFT3">
                    ...
                    <main class="modal__content px-4 !font-source-sans xl:px-8 astro-LUHUBFT3" id="modal-1-content">
                        <div class="flex flex-wrap items-center justify-center gap-3 astro-LUHUBFT3">
                            <ul class="flex w-full flex-row flex-wrap gap-3 astro-LUHUBFT3">
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Art" value="Art" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Art" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Art
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8 2C3.58853 2 0 5.58853 0 10C0 14.4115 3.58853 18 8 18C12.4115 18 16 14.4108 16 10C16 5.58916 12.4115 2 8 2ZM8 16.7607C4.27266 16.7607 1.23934 13.728 1.23934 10C1.23934 6.27203 4.27266 3.23934 8 3.23934C11.7273 3.23934 14.7607 6.27203 14.7607 10C14.7607 13.728 11.728 16.7607 8 16.7607Z" fill="#515151" class="astro-LUHUBFT3"></path>
                                            <path d="M11.0987 9.32457H8.61998V6.84588C8.61998 6.50382 8.34298 6.2262 8.00029 6.2262C7.6576 6.2262 7.3806 6.50382 7.3806 6.84588V9.32457H4.90191C4.55923 9.32457 4.28223 9.6022 4.28223 9.94426C4.28223 10.2863 4.55923 10.5639 4.90191 10.5639H7.3806V13.0426C7.3806 13.3847 7.6576 13.6623 8.00029 13.6623C8.34298 13.6623 8.61998 13.3847 8.61998 13.0426V10.5639H11.0987C11.4414 10.5639 11.7184 10.2863 11.7184 9.94426C11.7184 9.6022 11.4414 9.32457 11.0987 9.32457Z" fill="#515151" class="astro-LUHUBFT3"></path>
                                        </svg>
                                    </label>
                                </li>
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Biography" value="Biography" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Biography" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Biography
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Business" value="Business" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Business" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Business
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Children’s" value="Children’s" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Children’s" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Children’s
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Christian" value="Christian" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Christian" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Christian
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Classics" value="Classics" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Classics" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Classics
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Comics" value="Comics" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Comics" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Comics
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Cookbooks" value="Cookbooks" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Cookbooks" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Cookbooks
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Ebooks" value="Ebooks" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Ebooks" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Ebooks
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Fantasy" value="Fantasy" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Fantasy" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Fantasy
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Fiction" value="Fiction" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Fiction" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Fiction
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Graphic Noverls" value="Graphic Noverls" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Graphic Noverls" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Graphic Noverls
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Historical Fiction" value="Historical Fiction" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Historical Fiction" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Historical Fiction
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="History" value="History" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="History" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            History
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Horror" value="Horror" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Horror" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Horror
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Memoir" value="Memoir" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Memoir" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Memoir
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Music" value="Music" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Music" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Music
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Mystery" value="Mystery" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Mystery" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Mystery
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Nonfiction" value="Nonfiction" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Nonfiction" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Nonfiction
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Poetry" value="Poetry" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Poetry" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Poetry
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Psychology" value="Psychology" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Psychology" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Psychology
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Romance" value="Romance" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Romance" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Romance
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Science" value="Science" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Science" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Science
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Science Fiction" value="Science Fiction" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Science Fiction" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Science Fiction
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Self Help" value="Self Help" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Self Help" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Self Help
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Sports" value="Sports" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Sports" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Sports
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Thriller" value="Thriller" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Thriller" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Thriller
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Travel" value="Travel" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Travel" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Travel
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="astro-LUHUBFT3">
                                    <input type="checkbox" id="Young Adult" value="Young Adult" class="peer hidden astro-LUHUBFT3" required="">
                                    <label for="Young Adult" class="inline-flex w-full cursor-pointer items-center justify-between gap-3 rounded-full border border-[#EBEBEB] bg-white p-3 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:border-[#128C55] peer-checked:bg-[#128C55]/10 peer-checked:text-gray-600 xl:p-4 astro-LUHUBFT3">
                                        <div class="w-full text-sm font-semibold xl:text-lg astro-LUHUBFT3">
                                            Young Adult
                                        </div>
                                        <svg class="flex-shrink-0 astro-LUHUBFT3" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <footer class="flex h-20 w-full items-center justify-between bg-[#F9F8F6] p-4 xl:px-8 xl:py-12 astro-LUHUBFT3">
                        <button class="text-2xl font-bold leading-7 astro-LUHUBFT3">0/5</button>
                        <button class="rounded-full bg-[#128C55] px-6 py-4 font-source-sans text-base font-semibold leading-none tracking-widest text-white astro-LUHUBFT3" data-micromodal-close aria-label="Close this dialog window">Selesai</button>
                    </footer>
                </div>
            </div>
        </div>
