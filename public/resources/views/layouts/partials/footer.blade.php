<footer class="Footer relative w-full bg-[#F9F8F6]">
    <div class="container mx-auto max-w-screen-xl px-4 xl:px-12">
        <section class="flex flex-col items-start justify-between gap-5 pb-9 pt-6 xl:flex-row xl:items-center xl:pb-14 xl:pt-10">
            <!-- Left -->
            <div class="flex flex-col items-start">
                <a class="mb-6 text-xl xl:mb-14" href="/">
                    <img style="height: 40px;" src="https://www.jaritelunjuk.com/blog/wp-content/uploads/2021/10/Logo.png" alt="Jaritelunjuk Blog">
                </a>

                <a class="mb-6 text-lg font-bold leading-[22px] xl:mb-8 xl:text-[28px] xl:leading-[34px]" href="mailto:halo@jaritelunjuk.com">
                ...
                <nav class="flex flex-col items-start gap-3 xl:gap-5">
                    ...
                    <a href="{{route('leaderboard.index')}}">Leader Board</a>
                </nav>
            </div>

            <!-- Center -->
            <div class="relative h-auto w-full bg-white xl:h-80 xl:w-80" style="border-radius: 10px">
                <img class="h-full w-full object-cover" style="border-radius: 10px" src="https://cdn.jaritelunjuk.com/web-asset/footer-ill-02-01.jpg" alt="Footer Illustration">

            </div>

            <!-- Right -->
            <div class="space-y-6">
                <h5 class="text-lg font-semibold">Ikuti kami</h5>
                <div class="flex items-center gap-6">
                    <!-- Twitter -->
                    <a href="https://twitter.com/jaritelunjukcom" target="_blank">
                    ...
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/jaritelunjukcom/" target="_blank">
                        <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.facebook.com/jaritelunjukcom" target="_blank">
                        <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Linkedin -->
                    <a href="https://www.linkedin.com/company/jaritelunjuk/" target="_blank">
                        <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Tiktok -->
                    <a href="https://www.tiktok.com/@jaritelunjukcom" target="_blank">
                        <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
