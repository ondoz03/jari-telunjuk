<header
    class="Header fixed border-b-gray-50 bg-white shadow-sm inset-0 z-50 flex h-14 w-full border-b transition-all duration-300 ease-out xl:h-20">
    <div class="container mx-auto flex max-w-screen-xl items-center justify-between px-4 xl:px-12">
        ...
        <nav class="flex items-center gap-4 xl:hidden">
            <svg class="search_icon h-6 w-6 cursor-pointer"
                viewBox="0 0 24 24"
                fill="none"
