          ...
          <section class="col-span-1 xl:col-span-8">
            ...
            <div class="space-y-4 xl:space-y-10">
                @foreach ($buku as $item)
                    <figure class="group relative flex w-full flex-wrap items-start gap-3 xl:flex-nowrap xl:gap-8">
                        <a class="absolute z-10 h-full w-full" href="{{route('detail-buku', [$item->detail_buku->kategori->slug ,$item->slug])}}"></a>

                        {{-- <img class="aspect-video h-auto w-full rounded-md xl:h-48 xl:w-auto" src="{{$item->image}}" alt="Blog 1 Photo"> --}}
                        <img class="mb-6 w-full" src="{{ $item->image}}" style="height: 251px; width:171px" alt="Book Photo 1">


                        <div class="space-y-2 text-left">
                        <h5 class="text-base font-bold leading-5 group-hover:underline xl:text-2xl xl:leading-[28px]">
                            {{$item->judul}}
                        </h5>
                        ...
                        <p class="relative z-20 space-x-2 text-sm xl:text-base">
                            <span>Category</span>
                            <a href="{{ route("buku", $item->detail_buku->kategori->slug)}}" class="text-[#128C55] hover:underline">
                                {{$item->detail_buku->kategori->name}}
                            </a>
                        </p>

                        <p class="text-sm xl:text-base">
                            {{$item->penulis}} - {{$item->detail_buku->tgl_rilis}}
                        </p>
                        </div>
                    </figure>
                @endforeach
          ...
          <section class="col-span-1 xl:col-span-4">
            ...
            <div class="space-y-4 xl:space-y-6">
              <figure class="group relative flex w-full items-start gap-3 xl:gap-4">
                      <a class="absolute z-10 h-full w-full" href="/"></a>
                      ...
                      <div class="flex-1 space-y-2">
                        ...
                        <p class="relative z-20 space-x-2 text-sm xl:text-base">
                          <span>Category</span>
                          <a href="/category" class="text-[#128C55] hover:underline">
                            Self Improvement
                          </a>
                        </p>
                    ...
                    </figure><figure class="group relative flex w-full items-start gap-3 xl:gap-4">
                      <a class="absolute z-10 h-full w-full" href="/"></a>
